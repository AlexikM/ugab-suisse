...
1. **Ouvrez** `https://[adresse-du-site]/admin/` et connectez-vous.
2. Dans le menu de gauche, cliquez sur **Événements**, puis sur **New Événement**.
3. **Remplissez les champs.** Chaque champ porte une explication sous son
   intitulé — lisez-la en cas de doute, elle a été écrite pour vous.
4. **Téléversez la photo principale.** Elle sera redimensionnée automatiquement :
   n'y touchez pas avant de l'envoyer.
5. **Enregistrez en brouillon** si vous voulez le relire à tête reposée, ou faire
